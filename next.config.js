    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://static.axept.io https://client.axept.io https://www.googletagmanager.com https://widget.freshworks.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https: blob:; connect-src 'self' https://*.supabase.co https://api.resend.com https://static.axept.io https://client.axept.io https://www.google-analytics.com https://widget.freshworks.com; frame-src 'self' https://static.axept.io;"
          }
        ]
      }
    ]
